  ...
  void _loadData() async {
    ...
    final _profileImageExists =
        (await FirebaseStorage.instance.ref('profile_images').list())
            .items
            .any((e) => e.name == FirebaseAuth.instance.currentUser!.uid);
    Uint8List? imageData;
                ...
                Padding(
                  ...
                  child: Text(
                    AppLocalizations.of(context)!.matchedUsers(
                        List<String>.from(_currentUser!.get('matches')).length),
                                ...
                                try {
                                  ...
                                  for (final _matchedUser
                                    ...
                                    await _usersRef
                                        .doc(_matchedUser.id)
                                        .update({
                                      'matches': FieldValue.arrayRemove([_uid]),
                                    });
                                  }
